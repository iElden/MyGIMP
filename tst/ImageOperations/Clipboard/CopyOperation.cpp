...
#include "../../../src/ImageOperations/Clipboard/CopyOperation.hpp"
#include "../../../src/Editor.hpp"
#include "clip.h"

#define INT(x) (static_cast<int>(x))

TEST(CopyOperation, clickNoSelection) {
	tgui::Gui gui{};
...
TEST(CopyOperation, clickSelectAllLayer) {
	tgui::Gui gui{};
	Mimp::ToolBox toolBox{gui};
	Mimp::Editor e{};
	Mimp::CanvasWidget::Ptr cw = Mimp::CanvasWidget::create(toolBox, Mimp::Vector2<unsigned int>{10, 10});
...
TEST(CopyOperation, clickSelectOnePixel) {
	tgui::Gui gui{};
	Mimp::ToolBox toolBox{gui};
	Mimp::Editor e{};
	Mimp::CanvasWidget::Ptr cw = Mimp::CanvasWidget::create(toolBox, Mimp::Vector2<unsigned int>{10, 10});
...
TEST(CopyOperation, clickWholeLayerSquare) {
	tgui::Gui gui{};
	Mimp::ToolBox toolBox{gui};
	Mimp::Editor e{};
	Mimp::CanvasWidget::Ptr cw = Mimp::CanvasWidget::create(toolBox, Mimp::Vector2<unsigned int>{10, 10});
